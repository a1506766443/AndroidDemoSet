package com.wl.permissionstudylib.permission.aspect;

import android.content.Context;

import com.wl.permissionstudylib.permission.MyPermissionActivity;
import com.wl.permissionstudylib.permission.annotation.Permission;
import com.wl.permissionstudylib.permission.annotation.PermissionCancel;
import com.wl.permissionstudylib.permission.annotation.PermissionDenied;
import com.wl.permissionstudylib.permission.core.IPermission;
import com.wl.permissionstudylib.permission.util.PermissionUtils;
...
public class PermissionAspect {
    ...
    // * * 任何函数 都可以使用 此注解
    @Pointcut
    ("execution(@com.wl.permissionstudylib.permission.annotation.Permission * *(..)) && @annotation(permission)")
